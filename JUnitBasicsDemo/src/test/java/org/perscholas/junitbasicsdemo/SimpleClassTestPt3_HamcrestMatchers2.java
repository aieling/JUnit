...
import org.perscholas.test.SimpleClassTest;
import org.perscholas.test.SimpleObject;
...
public class SimpleClassTestPt3_HamcrestMatchers2 {
	private static SimpleClassTest simpleClass;
	
	@BeforeAll
	public static void createSimpleClass() {
		simpleClass = new SimpleClassTest();
	}
